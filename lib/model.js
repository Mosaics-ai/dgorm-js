    ...
    _execute(query) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                console.debug(`Model._execute - raw response (${this.schema.name}): `, rawResponseJson);
    ...
    _create(mutation, params) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                console.debug("dgOrm.model._create (_mutation): ", _mutation);
    ...
    _update(mutation, uid) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const mu = new this.connection.dgraph.Mutation();
                mutation.uid = uid;
                console.debug("dgOrm.model._update (mutation): ", mutation);
                mu.setCommitNow(true);
                mu.setSetJson(mutation);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof uid === 'object') {
                ...
                if (data && data.length > 0) {
                    ...
                    // Gather promises
                    let values = yield Promise.all(_uids.map(_uid => this._update(mutation, _uid)));
                    return values;
                }
            }
        });
