...
var Model = /** @class */ (function () {
    ...
    Model.prototype._execute = function (query) {
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var _txn, res, rawResponseJson, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, resolve(rawResponseJson[this.schema.name])];
                    case 3:
                        error_2 = _b.sent();
                        console.log("Error: Model._execute - ", error_2);
     ...
     */
    Model.prototype._parse_mutation_relation = function (mutation, key) {
        /** Is the relation a UID or object? */
        var _parse_relation = function (_relation) {
            return (typeof _relation === "string")
                ? { uid: _relation }
        ...
        if (Array.isArray(mutation[key])) {
            var _m_1 = [];
            mutation[key].forEach(function (_uid) {
                var relation = _parse_relation(_uid);
                if (relation) {
                    _m_1.push(relation);
                }
            });
    ...
    Model.prototype._parse_mutation = function (mutation, name) {
        ...
        Object.keys(mutation).forEach(function (_key) {
            if (_this._is_relation(_key)) {
                var _relation = _this._parse_mutation_relation(mutation, _key);
                if (_relation) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5:
                        ...
                        _uid = _mutation.getUidsMap().values().next().value;
                        console.log(_uid);
                        console.log("");
                    ...
                    case 7:
                        error_5 = _b.sent();
                        console.log("Error - dgOrm.model._create: ", error_5);
                        return [4 /*yield*/, _txn.discard()];
                    case 8:
                        _b.sent();
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        error_6 = _b.sent();
                        console.error("Error: dgOrm.model._update: ", error_6);
                        return [4 /*yield*/, _txn.discard()];
                    case 4:
                        _b.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        data_1 = _b.sent();
                        console.log("dgOrm.model.update (uid=object): ", data_1);
                        if (data_1.length > 0) {
