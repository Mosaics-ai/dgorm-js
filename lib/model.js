    ...
    update(data, uid) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof uid === 'object') {
                ...
                const found = yield this._method('has', hasKey, { filter });
                console.log("dgOrm.model.update (pre-update) (uid=object) (data/mutation/found): ", data, mutation, found);
                if (found && found.length > 0) {
                    ...
                    for (const _uid in _uids) {
                        const response = yield this._update(mutation, uid);
