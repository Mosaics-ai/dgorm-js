...
class DgraphORM {
    ...
    createModel(schema, background = false, retryConfig) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Predicates
            try {
                const response = yield helpers_1.retry(_setModel, retryConfig);
            ...
            // Types
            try {
                const response = yield helpers_1.retry(_setTypes, retryConfig);
                this._log('_setModel response: ', response);
            }
            catch (e) {
                ...
                if (e.includes('Schema does not contain a matching predicate for field')) {
                    // Predicates
                    try {
                        yield helpers_1.retry(_setModel, retryConfig);
                        yield helpers_1.sleep(1000);
                        yield helpers_1.retry(_setTypes, retryConfig);
                    }
                    catch (_a) { }
                }
                else if (!silent) {
    ...
    set_model(schema, background) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // predicates
            try {
                return yield this._generate_schema(schema.schema, background);
            }
            catch (e) {
