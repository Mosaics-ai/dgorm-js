...
class DgraphORM {
    ...
    constructor() {
        ...
        this.retry = (fn, n, delay = 2000) => __awaiter(this, void 0, void 0, function* () {
            for (let i = 0; i < n; i++) {
                try {
     ...
     */
    createModel(schema, background = false, retries = 1, retryDelay = 2000, silent = true) {
        return __awaiter(this, void 0, void 0, function* () {
            const _setModel = this.set_model(schema, background);
            const _setTypes = this.set_types(schema, background);
            // Predicates
            try {
                yield this.retry(_setModel, retries, retryDelay);
            }
            catch (e) {
            ...
            // Types
            try {
                yield this.retry(_setTypes, retries, retryDelay);
            }
            catch (e) {
